...
namespace ThrongBot.CrawlRunner.Bootstrap
{
    ...
    public class ApplicationModule : NinjectModule
    {
        public override void Load()
        {
            ...
            Bind<ThrongBot.Common.ICrawlDaddy>().To<ThrongBot.CrawlDaddy>().Named("Live");
            Bind<ThrongBot.Common.ICrawlDaddy>().To<ThrongBot.TestSupport.FakeCrawlDaddy>().Named("Fake");
        }
    }
